const questions = [
  ...
  "What are the hobbies you should do any why is youtube bad",
  "Why should you meditate daily?",
  "Why should you always journal in free time",
  "What should you think when someone says something that doesn't make sense",
...
const answers = [
  ...
  "The hobbies you should do are T.V. occasionally,Read, Journal, Walk, Listen to music and play tennis. Anything that is not gonna overstimulate your brain. Screens however are like a drug you are addicted to and aren't even happy while using. If you sacrifice happiness for comfort you deserve neither and will lose both although journaling should be the default.",
