const questions = [
  ...
  "How do most battles in real life need to be won",
  "What should you think whenever something doesn't make sense",
  "How in your head do you come up with mathematical equations for basic situations in real life",
  ...
  "What are the main ways to improve confidence",
  "What are the easiest habits to improve charisma?",
  "How do you flirt with woman",
...
const answers = [
  ...
  "Self talk. The you in your head should always be hyped up. You are awesome and you need to always remember it. People who don't talk well about themselves in their head seek it from other people. You can control it. Since our self talk is based on external world we get external validation which is bad since failure is experienced by everyone. Once you observe a negative thought separate that that is not you say it in a whiny beta voice. Don't depend on the external world for positive or negative self talk. Only change self talk based off of actions that are taken. Changing your thoughts changes yourself. So asking out someone is positive even if she responds negatively. This is how Kouenji acts he doesn't care about how the world reacts. Because he just is. Working out consistently is awesome and anything you do that is good makes you awesome. Once you do a goal give positive self talk. If there is something you don't do write it down as a regret for the day to review at the end. Every decision you make either puts you in a better headspace or lower so choose wisely and make the great actions. It makes you feel better more often being an awesome person and thinking about how awesome you are.",
  "Always get at least 8 hours of sleep if you plan on getting less you will rightfully convince yourself to get more except this will lead to a tired you making a bad decision and oversleeping what you healthily should be sleeping",
  ...
  "Remove any vices that you regret after consuming. A big one is smoking. You should also avoid getting drunk since you are starting to actually experience hangovers and bad for muscle gains. Another one you don't think is harmful is watching porn and masturbating. It lowers your energy and you don't feel good after don't forget that. You should at least try this since you keep removing and readding suggesting you realize this exists after the fact a.k.a the definition of a vice.",
  "You don't learn emotionally from past mistakes and tend to repeat them. Think about how many times you've hated weed anxiety and then done it again. Imagine how many times you get popcorn after remembering you don't love it anymore. For these things you are pushed to do them even though you don't like them/know they aren't good. Same with funny youtube videos. You need to have your logical mind have a greater control in what you do than your emotional mind. Another way to practice this skill is to better think in the mind of other people and think what they are thinking and why they are thinking it.",
  ...
  "Update beliefs by approximating bayes theorem in your head. Remember that P(A|B)=P(A)*P(B|A)/P(B). Use a rational prior belief. The belief given the claim and most importantly the probability of that event happening in general whether the claim is false or not(If a prior is low consider it negligible for P(B)). Also as early as possible come up with what would be possible for you to change your mind.",
  ...
  "Journaling is important because it is used to improve lateral thinking and create ideas for more efficiency and living a better life. It is also a form of waiting since not memorable and this is important as you gain memory by waiting more as there are more things that have greater significance. If something significant is always happening it is no longer significant. You can also remember different people you met in free time for remembering names. Remember boredom is fine as it leads to happiness. One must imagine sisyphus happy.",
  "Some battles need to be won by not fighting. Think about Shanks lesson to Luffy. If someone is trying to make you mad you can't argue with them. Don't let them dictate your emotional state. Only fight if it's something worth fighting for. Otherwise ignore it and move on with your life.",
  "Come up with 5 possibilities in your head using lateral thinking unless you figured out the solutions. Some are gonna be common like they are lying for one possibility and then you will need to evaluate the probability. Common ones will be that they are acting off incomlete info, have other constraints or ulterior motives",
  "Use mathematical induction basically. Find a really small base case and figure out what the equation would be for that and then find pattern.",
  ...
  "The best way to improve confidence is by 1. Remembering that just by performing an action you are being phenomenal and thus are worth it and are equals and superiors of the people you are talking to. If you are able to force yourself to talk to someone you are there equal. Also expect success instead of worrying about it. Harvey Specter does this and that is how is so confident",
  "The best way to be more charismatic is by Smiling. Speaking more confidently and have a lot of energy. Giving a pause before responding, use the persons name. The best drill to improve confidence is visualizing success in the scenario. This will condition yourself to feel better in the scenario that you are in. Keep in mind this won't create perfection and you will still feel discomfort. But this should improve performance.",
  "Playfully disagree by saying something like 'there's no way you actually believe that(and then press them playfully)', 'oh my god I thought you would have good opinions', or 'I'm going now(in playful manner) another way is say your cute but then light tease, you can also make fun assumptions about her, finally pretend like shes already really into you and misinterpret stuff she's saying to say that",
  "The best way to make fun small talk is to use reminds me of when talking about something instead of ending there in order to transition from a compliment. Often lateral thinking is helpful for transitioning between topics. Moreover, when asking questions go one step deeper and ask why. For example instead of asking what do you do for work. After that ask why they chose to do that. Finally ask fun hypothetical questions about what you are talking about, also guess a lot of answers instead of asking questions, put personal input/stories in whatever topic you are talking about and you can just start any conversation with a sup how are you doing finally by adding by the way at the end it sounds less interviewy",
  ...
  "Ask what would have to be true for this action to make sense?"
];
